              ...
              <div className="flex flex-col leading-none">
                ...
                <span
                  className={`text-[10px] font-medium tracking-widest uppercase transition-colors ${
                    scrolled ? "text-[#FF6B35]" : "text-orange-200"
                  }`}
                >
                  Ethiopia
                </span>
            ...
            <div className="hidden lg:flex items-center gap-3">
              <a
                ...
                className={`flex items-center gap-2 text-sm font-medium transition-colors ${
                  scrolled ? "text-[#5C4033]" : "text-white/80"
                } hover:text-[#FF6B35]`}
              >
                <Phone size={15} />
                097 511 1444
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed top-16 left-0 right-0 z-40 bg-white shadow-2xl border-t border-orange-100 lg:hidden"
          >
